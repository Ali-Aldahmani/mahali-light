    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div className="min-w-0 flex-1">
          ...
          {section === 'network' && (
            <SettingsSection title="Network & Mode" description="Static demo runtime environment.">
              <p className="text-sm text-ink">
                Environment: <strong className="text-success">Standalone Static Demo (Client-side)</strong>
              </p>
              <p className="text-sm text-ink-muted">
                PC identifier: <strong>DEMO-POS-01</strong>
              </p>
              <p className="text-sm text-ink-muted">
                Data layer: <strong>In-Memory Mock State (Zero Backend Required)</strong>
              </p>
            </SettingsSection>
          )}
          {section === 'attendance' && (
