...
const ROLE_DEFAULTS = {
  ...
  Manager: [
    ...
    'finance.view_dashboard', 'finance.view_pl', 'finance.view_balance_sheet',
    'finance.view_cashflow', 'finance.view_vat', 'finance.view_journal',
    'finance.export_reports',
    'report.financial', 'report.sales', 'report.inventory', 'report.customers', 'report.suppliers',
    'report.employees', 'report.attendance', 'report.warranty', 'report.returns', 'report.bills',
    'report.analytics',
