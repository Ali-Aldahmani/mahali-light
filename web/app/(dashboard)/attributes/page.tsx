...
import AttributeFormSlideOver from '@/components/products/AttributeFormSlideOver';
import {
  addAttributeValue,
  listAttributes,
...
function AttributesPageContent() {
  ...
  const filtered = items.filter((a) => {
    ...
    return (
      ...
      (a.values || []).some((v: any) => v.value.toLowerCase().includes(term))
    );
  });
  ...
  async function addValue(attr: any) {
...
function ExpandableRow({
  ...
  setNewValueDraft: (v: string) => void;
  onAddValue: () => void;
  onDeleteValue: (v: any) => void;
}) {
  return (
    <>
