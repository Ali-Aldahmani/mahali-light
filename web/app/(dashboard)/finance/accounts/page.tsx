...
import { listAccounts, createAccount, deleteAccount } from '@/services/financeService';
...
function buildTree(rows: any[]) {
  ...
  for (const n of byId.values()) n.children.sort((a: any, b: any) => a.code.localeCompare(b.code));
  return roots;
}
...
function NewAccountSlideOver({
  ...
  return (
    <SlideOver
      ...
      subtitle={parent ? `Parent: ${parent.code} ${parent.name}` : undefined}
      footer={
