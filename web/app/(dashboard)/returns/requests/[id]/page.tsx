...
import { formatCurrency, formatDateTime, timeAgo } from '@/lib/utils/format';
import type { ReturnRequest } from '../../types';

function ReturnRequestDetailPageContent() {
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 text-sm pt-2 border-t border-border">
              ...
              {request.invoiceNumber && (
                <Field
                  ...
                  value={
                    <Link
                      href={`/invoices/${request.referenceId}`}
              ...
              {request.supplierName && (
                <Field
                  ...
                  value={
                    <Link
                      href={`/suppliers/${request.supplierId}`}
                      className="text-accent hover:underline"
                    >
                      {request.supplierName}
                    </Link>
              ...
              <p className="text-sm">
                ...
                {request.order.replacementInvoiceId && (
                  <span>
                    ...
                    Replacement invoice{' '}
                    <Link
                      href={`/invoices/${request.order.replacementInvoiceId}`}
                      className="text-accent hover:underline"
                    >
                      created
                    </Link>
...
export default function ReturnRequestDetailPage() {
  return (
    <RequirePermission permission="return.request">
      <ReturnRequestDetailPageContent />
    </RequirePermission>
  );
}
