...
import StockImpactPreview from '@/components/ui/StockImpactPreview';
...
import { formatQty, formatRelativeTime } from '@/lib/utils/format';
import { onAdjustmentEvent } from '@/store/socketStore';
...
export default function AdjustmentsTab() {
  ...
  function openReview(req: any, mode: string) {
...
function Field({ label, value, block = false }: { label: string; value: any; block?: boolean }) {
  return (
    <div className={block ? '' : ''}>
