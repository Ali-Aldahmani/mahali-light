...
import { createCount } from '@/services/stockCountService';
...
export default function StartStockCountModal({
  open,
  onClose,
  onCreated,
}: {
  ...
  const categoryOptions = (categoriesFlat || []).map((c: any) => ({
    value: c.id,
