...
import StockMovementTimeline from '@/components/ui/StockMovementTimeline';
import { listVariantMovements } from '@/services/stockService';
import { MOVEMENT_TYPES, getMovementTypeLabel } from '@/components/ui/MovementTypeBadge';
