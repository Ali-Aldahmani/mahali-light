...
import { getCategoryAttributes, setCategoryAttributes } from '@/services/categoryService';
...
export default function CategoryAttributesPanel({
  ...
  function addAttribute(attr: any) {
  ...
  function toggleRequired(attributeId: number) {
    setItems((arr) =>
      arr.map((i) =>
