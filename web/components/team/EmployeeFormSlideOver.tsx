      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Input
            ...
            onChange={(e: any) => set('roleTitle', e.target.value)}
          />
          <Input
            label="Hire date"
            type="date"
            value={form.hireDate}
            onChange={(e: any) => set('hireDate', e.target.value)}
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Input
            ...
            onChange={(e: any) => set('shiftStart', e.target.value)}
          ...
          <Input
            ...
            type="time"
            value={form.shiftEnd}
            onChange={(e: any) => set('shiftEnd', e.target.value)}
        ...
        <div className="grid grid-cols-2 gap-3">
          <Input
            ...
            onChange={(e: any) => set('standardHours', e.target.value)}
          ...
          <Input
            ...
            onChange={(e: any) => set('lateThresholdMins', e.target.value)}
