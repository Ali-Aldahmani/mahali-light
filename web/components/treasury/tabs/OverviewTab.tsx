...
import NetPositionCard from '@/components/ui/NetPositionCard';
...
import { getTreasurySummary } from '@/services/treasuryService';
...
interface TreasurySummary {
  cash: { balance: number; status: string };
  banks: { total: number; accounts: unknown[] };
  receivables: number;
  payables: number;
  today: { moneyIn: number; moneyOut: number; inCount: number; outCount: number };
...
export default function OverviewTab({ onJumpTab }: OverviewTabProps) {
