...
import { getCashSession } from '@/services/cashDrawerService';
...
export default function ReconciliationSummary({ data, onClear }: ReconciliationSummaryProps) {
  ...
  function getCount(type: string, dir: string) {
