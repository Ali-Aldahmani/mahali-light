...
import * as api from '@/services/backupService';
...
interface BackupState {
  ...
  restoreImminent: RestoreImminent | null;
  ...
  fetchUsbDrives: () => Promise<void>;
  fetchMaintenance: () => Promise<void>;

  runBackup: (type: any) => Promise<void>;
  saveSettings: (patch: any) => Promise<any>;
  testNasConnection: (body: any) => Promise<any>;
  triggerRestore: (jobId: any, delay?: number) => Promise<void>;
  cleanupRetention: () => Promise<void>;

  onBackupStarted: (payload: any) => void;
  onBackupCompleted: (payload: any) => void;
