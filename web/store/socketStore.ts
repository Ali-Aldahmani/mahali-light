...
import { handleStockUpdate, syncOnReconnect } from '@/services/stockCacheService';
...
function makeBus() {
  ...
  return {
    on(cb: EventCallback): Unsubscribe {
      listeners.add(cb);
...
export const onProductUpdate = (cb: EventCallback): Unsubscribe => productBus.on(cb);
export const onStockUpdate = (cb: EventCallback): Unsubscribe => stockBus.on(cb);
export const onReorderAlert = (cb: EventCallback): Unsubscribe => reorderBus.on(cb);
export const onAdjustmentEvent = (cb: EventCallback): Unsubscribe => adjustmentBus.on(cb);
export const onCountEvent = (cb: EventCallback): Unsubscribe => countBus.on(cb);
export const onPurchaseOrderEvent = (cb: EventCallback): Unsubscribe => poBus.on(cb);
export const onSupplierReturnEvent = (cb: EventCallback): Unsubscribe => supplierReturnBus.on(cb);
export const onCustomerBalanceUpdate = (cb: EventCallback): Unsubscribe => customerBus.on(cb);
export const onInvoiceEvent = (cb: EventCallback): Unsubscribe => invoiceBus.on(cb);
export const onInvoiceEditRequestEvent = (cb: EventCallback): Unsubscribe => invoiceEditRequestBus.on(cb);
export const onPdfReady = (cb: EventCallback): Unsubscribe => pdfBus.on(cb);
export const onPrintRequest = (cb: EventCallback): Unsubscribe => printBus.on(cb);
export const onWarrantyEvent = (cb: EventCallback): Unsubscribe => warrantyBus.on(cb);
export const onWarrantyClaimEvent = (cb: EventCallback): Unsubscribe => warrantyClaimBus.on(cb);
export const onReturnEvent = (cb: EventCallback): Unsubscribe => returnBus.on(cb);
export const onTreasuryEvent = (cb: EventCallback): Unsubscribe => treasuryBus.on(cb);
export const onAttendanceEvent = (cb: EventCallback): Unsubscribe => attendanceBus.on(cb);
export const onLeaveEvent = (cb: EventCallback): Unsubscribe => leaveBus.on(cb);
export const onCorrectionEvent = (cb: EventCallback): Unsubscribe => correctionBus.on(cb);
export const onHolidayEvent = (cb: EventCallback): Unsubscribe => holidayBus.on(cb);
export const onBillEvent = (cb: EventCallback): Unsubscribe => billBus.on(cb);
export const onExpenseEvent = (cb: EventCallback): Unsubscribe => expenseBus.on(cb);
...
export const useSocketStore = create<SocketState>()((set, get) => ({
  ...
  connect: () => {
    ...
    socket.on('leave_request_reviewed', (payload) => {
      ...
      const myEmployeeId = (useAuthStore.getState().user as any)?.employeeId;
