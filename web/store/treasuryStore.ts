...
import { getDrawerState } from '@/services/cashDrawerService';
...
interface TreasuryState {
  ...
  cashBalance: number;
  drawerStatus: string;
  drawerSessionId: string | number | null;
  banksTotal: number;
  ...
  applyCashEvent: (payload: CashEventPayload) => void;
  applyBankEvent: (payload: BankEventPayload) => void;
  reset: () => void;
}
